    ...
    <>
      <div className="w-full min-h-screen bg-white px-4 py-8 lg:px-20 flex justify-center items-start">
        <div className="w-full max-w-4xl">
          <h2 className="text-3xl max-md:text-xl max-md:line-clamp-2 font-semibold text-gray-900 mb-6 text-center" style={{
            fontFamily: 'Youth',
            fontWeight: 900,
            lineHeight: '1.2',
            letterSpacing: '0%',
          }}>Enquiry Form Support for High-Value Unsecured Loan Holders
          </h2>

          <p className="text-lg max-md:text-sm text-black mb-6 text-center" style={{
            fontFamily: 'gilroy',
            fontWeight: 400,
            lineHeight: '1.4',
            letterSpacing: '0%',
          ...
          >
            This consultation is strictly for individuals with unsecured loan exposure of ₹40 lakhs or above who are facing repayment stress. (We do not provide loans or credit of any kind. This is not a lending service)
            ...
            <div>
              ...
              <div className="relative">
                <select {...register("monthlyIncome")} className="w-full px-4 py-3 bg-[#f1f2f6] text-gray-600 rounded-xl appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500">
                  ...
                  <option value="60000-80000">Rs.60,000 - 80,000 per month</option>
                  <option value="80000-100000">Rs.80,000 - 1,00,000 per month</option>
                  <option value="100000-150000">Rs.1,00,000 - 1,50,000 per month</option>
                  <option value="150000-200000">Rs. 1,50,000 - 2,00,000 per month</option>
                  <option value="200000-250000">Rs. 2,00,000 - 2,50,000 per month</option>
                  <option value="250000-300000">Rs. 2,50,000 - 3,00,000 per month</option>
                  <option value="300000-400000">Rs. 3,00,000 - 4,00,000 per month</option>
                  <option value="400000-500000">Rs. 4,00,000 - 5,00,000 per month</option>
            ...
            <div>
              ...
              <div className="relative">
                <select {...register("loanDues")} className="w-full px-4 py-3 bg-[#f1f2f6] text-gray-600 rounded-xl appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500">
                  ...
                  <option value="40-60L">Rs. 40 - 60 Lacs</option>
                  <option value="60-80L">Rs. 60 - 80 Lacs</option>
                  <option value="80L-1Cr">Rs. 80Lacs - 1Crore</option>
                  <option value="1-1.5Cr">Rs. 1 - 1.5 Crore</option>
                  <option value="1.5-2Cr">Rs. 1.5 - 2 Crore</option>
                  <option value="2Cr+">Rs. 2 Crore+</option>
                </select>
                <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-gray-700">
                  <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" /></svg>
                </div>
