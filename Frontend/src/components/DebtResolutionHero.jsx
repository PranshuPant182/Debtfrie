...
const DebtResolutionHero = ({ onGetStarted }) => {
    ...
    return (
        <div
            ref={heroRef}
            className="w-full min-h-screen bg-[#ebf1fc] flex flex-col lg:flex-row items-center justify-between overflow-hidden"
        >
            {/* Left Section: Text */}
            ...
            <div className="flex-1 w-full h-full p-0 relative overflow-hidden">
                <div className={`transform transition-all duration-1200 ease-out ${isVisible
                    ...
                    <img
                        src={images.Women}
                        alt="Hero Visual"
                        className="w-full h-full object-cover p-0 m-0 mt-9 sm:mt-36 hover:scale-105 transition-transform duration-700"
                    />

                    {/* Floating elements for visual enhancement */}
                    <div className={`absolute top-20 right-10 w-16 h-16 bg-blue-200 rounded-full opacity-20 transition-all duration-1000 ${isVisible ? 'animate-bounce' : ''
                        }`}></div>
                    <div className={`absolute bottom-32 left-10 w-12 h-12 bg-indigo-200 rounded-full opacity-30 transition-all duration-1000 delay-500 ${isVisible ? 'animate-pulse' : ''
                        }`}></div>
                </div>
            </div>
...
export default DebtResolutionHero;