...
const DebtCalculator_Resolution = () => {
            ...
            <div className="w-full max-w-2xl bg-white shadow-lg rounded-2xl p-6 space-y-10" style={{
                ...
                <div className="mt-8">
                    ...
                    <p className="text-sm text-gray-700 mb-4">
                        ...
                        With Debtfrie, it can be resolved to just
                        <span className="font-bold">₹{settlementAmount.toLocaleString()}</span>, saving you
...
export default DebtCalculator_Resolution;