...
import { Search, Filter, Eye, Edit, Calendar, Phone, Mail, MapPin, Trash2, X, LogOut } from 'lucide-react';
      ...
      <div className="bg-[#02102f] text-white p-4 sm:p-6">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="flex items-center space-x-2 bg-red-600 hover:bg-red-700 text-black px-4 py-2 rounded-lg transition duration-200 text-sm font-medium"
            title="Logout"
          >
